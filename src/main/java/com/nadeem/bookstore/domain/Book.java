package com.nadeem.bookstore.domain;
...
public class Book implements Serializable {
	private static final long serialVersionUID = 34345353L;
	@Id
	...
	public Book(String title, String author, String publisher, String publicationDate, String language, String category,
			int numberOfPages, String format, String isbn, double shippingWeight, double listPrice, double ourPrice,
